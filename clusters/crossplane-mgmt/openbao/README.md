# OpenBao Kubernetes auth for `crossplane-mgmt`
...
| | |
|---|---|
| Auth mount created here | `/v1/auth/crossplane-mgmt-sthings-certmanager` |
...
| Terraform state | `kubernetes` backend, Secret suffix `openbao-crossplane-mgmt-sthings`, namespace `cert-manager`, in this cluster |
...
KUBECONFIG_PATH=/home/sthings/.kube/crossplane-mgmt \
