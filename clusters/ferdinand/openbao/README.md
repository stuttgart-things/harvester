# OpenBao Kubernetes auth for `ferdinand`
...
| | |
|---|---|
| Auth mount created here | `/v1/auth/ferdinand-sthings-certmanager` |
...
| Terraform state | `kubernetes` backend, Secret suffix `openbao-ferdinand-sthings`, namespace `cert-manager`, in this cluster |
...
KUBECONFIG_PATH=/home/sthings/.kube/ferdinand \
